                            ...
                            <li key={index}>
                                <p> 
                                    <Tooltip content={`email: ${colleague.User.email}`} showDelay={1000}>
                                        <div className={style.profileName}> <Avatar name={`${colleague.User.firstName} ${colleague.User.lastName}`} size={40} marginRight={10}/> {colleague.User.firstName} {colleague.User.lastName} </div>
                                    </Tooltip>
                                    <div style={{display:'flex', alignItems:'center', width:'25vw'}}>{colleague.role}</div>
