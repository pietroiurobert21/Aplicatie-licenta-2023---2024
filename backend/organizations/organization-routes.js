...
const { postOrganization, getOrganizationByCode, getOrganizationMembers, getOrganizationById, getOrganizationByUserId } = require("./organization-controller"); // Import the functions from the controller
