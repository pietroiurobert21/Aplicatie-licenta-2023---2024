...
const { getUsers, getUserById, postUser, loginUser, belongsToOrganization, updateUser, updatePassword } = require("../controllers/users-controller"); // Import the functions from the controller
