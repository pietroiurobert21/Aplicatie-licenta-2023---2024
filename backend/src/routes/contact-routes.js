...
const { addContact, getContactsByOrganizationId, getContactById, getCustomersByOrganizationId, deleteContactById, updateContact, switchPipelineStatus } = require("../controllers/contact-controller")
...
router.put("/switchPipeline", verifyToken, switchPipelineStatus)
